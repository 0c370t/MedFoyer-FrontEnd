<script>
    ...
    import CompleteProfile from './pages/Login/CompleteProfile.svelte'
    import VerifyEmail from './pages/Login/VerifyEmail.svelte';
...
<Router {url}>
    ...
    <Route path='/clinic/login/change_password' component='{ChangePassword}'/>
    <Route path='/clinic/login/verify_email' component='{VerifyEmail}'/>
    <Route path='/'>
