...
<Drop mode="hover" pos="bottom-right" boundary="#master-header" animation="uk-animation-slide-top-small" bind:this={dropElem} _class="uk-background-secondary uk-light" padsize="small">
    ...
    <ul class="uk-dropdown-nav uk-padding-small" bind:this={navElement}>
        <li class="uk-parent">
            ...
            <ul>
                <li class="uk-margin-small">
                    <button class="uk-button uk-button-default uk-button-small uk-text-left" on:click={() => {dispatch("create-patient");dropElem.hide(0);}}>
                        <Icon icon="user"/>
        ...
        <li class="uk-parent">
            ...
            <ul>
                <li class="uk-margin-small">
                    <button class="uk-button uk-button-default uk-button-small" on:click={() => {dispatch("create-appointment");dropElem.hide(0);}}>
                        <Icon icon="calendar"/>
        ...
        {#if $user.admin}
            <li class="uk-parent">
                <a class="uk-button uk-button-default uk-button-small uk-text-left uk-margin-small-bottom"><Icon icon="cog" _class="uk-margin-small-left"/> Administration</a>
                <ul>
                    <li class="uk-margin-small">
                        <button class="uk-button uk-button-default uk-button-small" on:click={() => {navigate("/clinic/admin");dropElem.hide(0)}}>
                            <Icon icon="settings"/>
